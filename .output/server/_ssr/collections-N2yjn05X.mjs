//#region node_modules/.nitro/vite/services/ssr/assets/collections-N2yjn05X.js
var collections = [
	{
		slug: "living",
		name: "Living Room Collection",
		items: "Sofas · Coffee Tables · TV Units · Consoles",
		blurb: "Gold-gilt classic sofa sets, embroidered upholstery and quiet modern seating — built for rooms that host.",
		...
		gallery: [
			...
			{
				file: "living-04-gold-navy-sofa.webp",
				alt: "Gold-framed sofa set with navy upholstery"
			},
			{
	...
	},
	{
		...
		blurb: "From deeply carved mahogany frames to emerald velvet minimalism — beds finished to be lived with for decades.",
		...
		gallery: [
			...
			{
				file: "bedroom-04-emerald-gold-bed.webp",
				alt: "Emerald and gold upholstered bed"
			},
			{
	...
	},
	{
		...
		blurb: "Carved hardwood, marble tops and champagne-gilt finishes — dining sets sized to your room, not a catalogue.",
		...
		gallery: [
			...
			{
				file: "dining-06-carved-wood-dining.webp",
				alt: "Carved wooden dining table and chairs"
			},
			{
	...
	},
	{
		...
		blurb: "Director desks, conference tables and workstations delivered as complete, coordinated corporate interiors.",
		...
		gallery: [
			...
			{
				file: "office-05-workspace.webp",
				alt: "Office lounge table and workspace seating"
			},
			{
	...
	},
	{
		...
		blurb: "Showcase cabinets, shoe storage and wall units engineered to the exact centimetre of the space you have.",
		...
		gallery: [
			...
			{
				file: "custom-03-shoe-cabinet-sideboard.webp",
				alt: "Shoe cabinet and sideboard unit"
			},
			{
				file: "custom-04-gold-showcase.webp",
				alt: "Gold-framed glass showcase unit"
			},
			{
...
var bespokeProcess = [
	{
		no: "01",
		title: "Meet",
		body: "New client meeting, brief understanding."
	},
	{
		no: "02",
		title: "Research",
		body: "Brainstorming and preparation."
	},
	{
		no: "03",
		title: "Design",
		body: "Refine the concept around your space."
	},
	{
		no: "04",
		title: "Craft",
		body: "Skilled in-house craftsmanship, premium materials."
	},
	{
		no: "05",
		title: "Deliver",
		body: "Delivery, setup and installation."
	}
];
var milestones = [
	{
		year: "2020",
		text: "Founded by Abul Kalam Bhuiyan"
	},
	{
		year: "2021",
		text: "Registered and opened the Agrabad Showroom"
	},
	{
		year: "2024 & 2025",
		text: "Participated in the International Furniture Fair, Chattogram"
	},
	{
		year: "2025",
		text: "Became a member of the Chamber of Commerce"
	},
	{
		year: "2026",
		text: "Received the BFIOA recognition nationwide"
	}
];
var caseStudy = {
	client: "FYTOBYTE LTD",
	...
	images: [
		...
		{
			file: "fytobyte-01-director-office.webp",
			alt: "Director office furnished for FYTOBYTE Ltd"
		},
		{
			file: "fytobyte-03-reception.webp",
			alt: "Reception area furnished for FYTOBYTE Ltd"
		},
		{
			file: "fytobyte-04-workstation.webp",
			alt: "Workstation area furnished for FYTOBYTE Ltd"
		}
	]
};
var eventPhotos = [
...
//#endregion
export { milestones as a, eventPhotos as i, caseStudy as n, collections as r, bespokeProcess as t };
